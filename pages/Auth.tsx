    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-xl border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif font-bold text-xl text-slate-50 tracking-tight">
              WeddingFilmAI
            </span>
          </div>
          <button
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 flex flex-col items-center justify-center min-h-[90vh]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 w-full">
          ...
          >
            Φέρτε την οργάνωση των projects σας και την παραγωγή σεναρίων στο
            επόμενο επίπεδο. Ενισχύστε τη δημιουργικότητά σας με εργαλεία
            τεχνητής νοημοσύνης.
          </motion.p>
          ...
          >
            <div className="flex items-center gap-2">
              <CheckCircle2 size={16} /> Δωρεάν Δοκιμή
            </div>
            <div className="hidden sm:flex items-center gap-2">
              <Shield size={16} /> Ασφάλεια Δεδομένων
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Ενώστε το workflow σας σε ένα απλό, minimal περιβάλλον φτιαγμένο
              αποκλειστικά για επαγγελματίες του βίντεο.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f, i) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center mb-6 shadow-lg ${f.color}`}
                >
                  {f.icon}
                </div>
      ...
      {/* Final CTA */}
      <section
        className="py-32 px-6 relative border-t border-slate-800/50"
        style={{ backgroundColor: "#b79ed8" }}
      >
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-4xl md:text-5xl font-bold font-serif text-white leading-tight">
            Μεταμορφώστε το Studio σας σήμερα.
          </h2>
          <button
            onClick={handleGoogleSignIn}
            disabled={signingIn}
